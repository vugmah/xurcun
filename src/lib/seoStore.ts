...
const PAGE_TEMPLATES: Record<string, {
  ...
  menu: {
    ...
    titleRu: "Меню | Xurcun White City — Еда, Напитки и Кальян",
    titleEn: "Menu | Xurcun White City — Food, Beverages & Shisha",
    titleTr: "Menü | Xurcun White City — Yemek, İçecek ve Nargile",
    descAz: "Xurcun White City menyusu — müasir Azərbaycan və Avropa yeməkləri, imza kokteyllər, geniş şərab seçimi və premium qəlyan çeşidləri.",
    descRu: "Меню Xurcun White City — современная азербайджанская и европейская кухня, фирменные коктейли, богатая винная карта и премиальный кальян.",
    descEn: "Xurcun White City menu — modern Azerbaijani and European cuisine, signature cocktails, extensive wine selection and premium shisha varieties.",
    descTr: "Xurcun White City menüsü — modern Azerbaycan ve Avrupa mutfağı, imza kokteyller, geniş şarap seçimi ve premium nargile çeşitleri.",
    kwAz: "menyu bakı, yemek menyusu, içki menyu, qəlyan menyu, restoran menyu",
    kwRu: "меню баку, меню ресторан, кальян меню, коктейли баку",
    kwEn: "menu baku, food menu, beverage menu, shisha menu, restaurant menu",
    kwTr: "menü baku, yemek menüsü, içecek menüsü, nargile menüsü, restoran menüsü",
  },
  food: {
    titleAz: "Yemek Menyusu | Xurcun White City — A La Carte",
    titleRu: "Меню еды | Xurcun White City — A La Carte",
    titleEn: "Food Menu | Xurcun White City — A La Carte",
    titleTr: "Yemek Menüsü | Xurcun White City — A La Carte",
  ...
  beverage: {
    titleAz: "İçki Menyusu | Xurcun White City — Kokteyllər və Şərablar",
    titleRu: "Меню напитков | Xurcun White City — Коктейли и Вино",
    titleEn: "Beverage Menu | Xurcun White City — Cocktails & Wine",
    titleTr: "İçecek Menüsü | Xurcun White City — Kokteyller ve Şaraplar",
  ...
  shisha: {
    titleAz: "Qəlyan Menyusu | Xurcun White City — Premium Qəlyan",
    titleRu: "Меню кальяна | Xurcun White City — Премиальный Кальян",
    titleEn: "Shisha Menu | Xurcun White City — Premium Shisha",
    titleTr: "Nargile Menüsü | Xurcun White City — Premium Nargile",
  ...
  snack: {
    titleAz: "Snack Menyu | Xurcun White City — Gecə Yeməkləri",
    titleRu: "Снэк-меню | Xurcun White City — Ночные Закуски",
    titleEn: "Snack Menu | Xurcun White City — Late Night Bites",
    titleTr: "Snack Menü | Xurcun White City — Gece Yiyecekleri",
  ...
  about: {
    titleAz: "Haqqımızda | Xurcun White City — Restoran və Lounge",
    titleRu: "О нас | Xurcun White City — Ресторан и Лаунж",
    titleEn: "About Us | Xurcun White City — Restaurant & Lounge",
    titleTr: "Hakkımızda | Xurcun White City — Restoran ve Lounge",
    descAz: "Xurcun White City — Bakının White City hissəsində yerləşən premium restoran və lounge. Ləzzətli yeməklər, canlı musiqi və xüsusi atmosfer.",
    descRu: "Xurcun White City — премиальный ресторан и лаунж в районе White City, Баку. Вкусная еда, живая музыка и особенная атмосфера.",
    descEn: "Xurcun White City — a premium restaurant and lounge in White City, Baku. Delicious food, live music and a special atmosphere.",
    descTr: "Xurcun White City — Bakü'nün White City bölgesinde premium bir restoran ve lounge. Lezzetli yemekler, canlı müzik ve özel atmosfer.",
    kwAz: "haqqımızda, restoran haqqında, xurcun, lounge bakı",
    kwRu: "о нас, о ресторане, xurcun, лаунж баку",
    kwEn: "about us, restaurant about, xurcun, lounge baku",
    kwTr: "hakkımızda, restoran hakkında, xurcun, lounge baku",
  },
  gallery: {
    titleAz: "Qalereya | Xurcun White City — Foto və Video",
    titleRu: "Галерея | Xurcun White City — Фото и Видео",
    titleEn: "Gallery | Xurcun White City — Photos & Videos",
    titleTr: "Galeri | Xurcun White City — Fotoğraf ve Video",
    descAz: "Xurcun White City qalereyası — restoranımızın interyeri, yeməklərimiz, tədbirlərimiz və unudulmaz anların foto və videoları.",
    descRu: "Галерея Xurcun White City — интерьер нашего ресторана, наши блюда, мероприятия и фото и видео незабываемых моментов.",
    descEn: "Xurcun White City gallery — our restaurant interior, our dishes, events and photos and videos of unforgettable moments.",
    descTr: "Xurcun White City galerisi — restoranımızın iç mekanı, yemeklerimiz, etkinlikler ve unutulmaz anların fotoğraf ve videoları.",
  ...
  events: {
    titleAz: "Tədbirlər | Xurcun White City — Xüsusi Tədbirlər",
    titleRu: "Мероприятия | Xurcun White City — Особые События",
    titleEn: "Events | Xurcun White City — Private Events",
    titleTr: "Etkinlikler | Xurcun White City — Özel Etkinlikler",
    descAz: "Xurcun White City-də xüsusi tədbirlər — ad günü, korporativ tədbirlər, romantik şam yeməyi və daha çoxu.",
    descRu: "Особые мероприятия в Xurcun White City — дни рождения, корпоративные мероприятия, романтический ужин и многое другое.",
    descEn: "Private events at Xurcun White City — birthdays, corporate events, romantic dinners and more.",
    descTr: "Xurcun White City'de özel etkinlikler — doğum günleri, kurumsal etkinlikler, romantik akşam yemekleri ve daha fazlası.",
  ...
  contact: {
    titleAz: "Əlaqə | Xurcun White City — Ünvan və Telefon",
    titleRu: "Контакты | Xurcun White City — Адрес и Телефон",
    titleEn: "Contact | Xurcun White City — Address & Phone",
    titleTr: "İletişim | Xurcun White City — Adres ve Telefon",
    descAz: "Xurcun White City ilə əlaqə — ünvan: 1-ci Yaşıl Ada Küçəsi, White City, Bakı. Telefon: +994 50 213 05 55. Rezervasiya üçün zəng edin.",
    descRu: "Контакты Xurcun White City — адрес: 1-ci Yaşıl Ada Küçəsi, White City, Баку. Телефон: +994 50 213 05 55. Звоните для резервации.",
    descEn: "Contact Xurcun White City — address: 1-ci Yaşıl Ada Küçəsi, White City, Baku. Phone: +994 50 213 05 55. Call for reservations.",
    descTr: "Xurcun White City iletişim — adres: 1-ci Yaşıl Ada Küçəsi, White City, Bakü. Telefon: +994 50 213 05 55. Rezervasyon için arayın.",
  ...
  reservation: {
    titleAz: "Rezervasiya | Xurcun White City — Masa Rezervasiyası",
    titleRu: "Бронирование | Xurcun White City — Резерв Стола",
    titleEn: "Reservation | Xurcun White City — Table Booking",
    titleTr: "Rezervasyon | Xurcun White City — Masa Rezervasyonu",
    descAz: "Xurcun White City-də masa rezervasiyası — WhatsApp üzərən sürətli və asan rezervasiya. White City və Seabreeze Marina filialları.",
    descRu: "Резерв стола в Xurcun White City — быстрое и удобное бронирование через WhatsApp. Филиалы White City и Seabreeze Marina.",
    descEn: "Table reservation at Xurcun White City — quick and easy booking via WhatsApp. White City and Seabreeze Marina branches.",
    descTr: "Xurcun White City'de masa rezervasyonu — WhatsApp üzerinden hızlı ve kolay rezervasyon. White City ve Seabreeze Marina şubeleri.",
  ...
  qr: {
    titleAz: "QR Menyu | Xurcun White City — Online Menyu",
    titleRu: "QR Меню | Xurcun White City — Онлайн Меню",
    titleEn: "QR Menu | Xurcun White City — Online Menu",
    titleTr: "QR Menü | Xurcun White City — Online Menü",
    descAz: "Xurcun White City QR menyu — telefonunuzdan yemək, içki və qəlyan sifariş edin. White City və Seabreeze Marina filialları.",
    descRu: "QR-меню Xurcun White City — заказывайте еду, напитки и кальян с телефона. Филиалы White City и Seabreeze Marina.",
    descEn: "Xurcun White City QR menu — order food, beverages and shisha from your phone. White City and Seabreeze Marina branches.",
    descTr: "Xurcun White City QR menü — telefonunuzdan yemek, içecek ve nargile sipariş edin. White City ve Seabreeze Marina şubeleri.",
  ...
  privacy: {
    titleAz: "Məxfilik Siyasəti | Xurcun White City",
    titleRu: "Политика конфиденциальности | Xurcun White City",
    titleEn: "Privacy Policy | Xurcun White City",
    titleTr: "Gizlilik Politikası | Xurcun White City",
    descAz: "Xurcun White City məxfilik siyasəti — şəxsi məlumatlarınızın qorunması, cookie istifadəsi və hüquqlarınız.",
    descRu: "Политика конфиденциальности Xurcun White City — защита ваших персональных данных, использование cookie и ваши права.",
    descEn: "Xurcun White City privacy policy — how we protect your personal data, cookie usage, and your rights.",
    descTr: "Xurcun White City gizlilik politikası — kişisel verilerinizin korunması, çerez kullanımı ve haklarınız.",
  ...
  "cookie-policy": {
    titleAz: "Cookie Siyasəti | Xurcun White City",
    titleRu: "Политика использования cookies | Xurcun White City",
    titleEn: "Cookie Policy | Xurcun White City",
    titleTr: "Çerez Politikası | Xurcun White City",
    descAz: "Xurcun White City cookie siyasəti — saytda istifadə olunan cookie-lər, kateqoriyalar və razılıq idarəsi.",
    descRu: "Политика использования cookies Xurcun White City — cookies на сайте, категории и управление согласием.",
    descEn: "Xurcun White City cookie policy — cookies used on the site, categories, and consent management.",
    descTr: "Xurcun White City çerez politikası — sitede kullanılan çerezler, kategoriler ve izin yönetimi.",
...
export const SEO_PAGES = [
  ...
  { id: "menu", labelAz: "Menyu", labelEn: "Menu", labelRu: "Меню", labelTr: "Menü" },
  { id: "food", labelAz: "Yemək Menyusu", labelEn: "Food Menu", labelRu: "Меню еды", labelTr: "Yemek Menüsü" },
  { id: "beverage", labelAz: "İçki Menyusu", labelEn: "Beverage Menu", labelRu: "Меню напитков", labelTr: "İçecek Menüsü" },
  { id: "shisha", labelAz: "Qəlyan Menyusu", labelEn: "Shisha Menu", labelRu: "Меню кальяна", labelTr: "Nargile Menüsü" },
  { id: "snack", labelAz: "Snack Menyu", labelEn: "Snack Menu", labelRu: "Снэк-меню", labelTr: "Snack Menü" },
  { id: "about", labelAz: "Haqqımızda", labelEn: "About Us", labelRu: "О нас", labelTr: "Hakkımızda" },
  { id: "gallery", labelAz: "Qalereya", labelEn: "Gallery", labelRu: "Галерея", labelTr: "Galeri" },
  { id: "events", labelAz: "Tədbirlər", labelEn: "Events", labelRu: "Мероприятия", labelTr: "Etkinlikler" },
