...
const DEFAULTS: GeneralSettings = {
  ...
  googleReviewUrl: "",
  defaultSeoTitle: "Xurcun White City | Premium Restoran, Lounge və Qəlyan",
  defaultSeoDescription: "Bakının White City hissəsində yerləşən premium restoran və lounge.",
  gtmId: "",
  ga4MeasurementId: "",
  googleAdsId: "",
  metaPixelId: "",
