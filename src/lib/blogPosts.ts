// Xurcun blog — evergreen, SEO-focused articles. Multilingual (AZ/RU/EN);
// TR/AR fall back to AZ via pickL(). Content-in-code (no CMS). Slugs mirrored
// in api/lib/vite.ts (ROUTE_META) and api/boot.ts (sitemap).

export type Lang = 'az' | 'ru' | 'en' | 'tr' | 'ar';
export type L = { az: string; ru: string; en: string };
...
// AZ is the source of truth; RU/EN provided. TR/AR fall back to AZ.
...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    sections: [
      {
        h2: { az: "Novruz üçün", ru: "Для Новруза", en: "For Novruz" },
        body: [
          { az: "Novruz süfrəsinin yaraşığı — quru meyvə, qoz-fındıq, şəkərbura və paxlava. Xurcun bayram qutuları milli ənənəni premium keyfiyyətlə birləşdirir.", ru: "Украшение новрузского стола — сухофрукты, орехи, шекербура и пахлава. Праздничные коробки Xurcun сочетают традицию и премиальное качество.", en: "The Novruz table's pride — dried fruit, nuts, shakarbura and baklava. Xurcun holiday boxes blend tradition with premium quality." },
        ],
      },
      {
        h2: { az: "Ramazan və Yeni il üçün", ru: "Для Рамазана и Нового года", en: "For Ramadan and New Year" },
        body: [
          { az: "Ramazanda lokum, xurma və çay dəstləri; Yeni ildə isə şokolad və qarışıq hədiyyə qutuları ən çox seçilən variantlardır.", ru: "В Рамазан — лукум, финики и чайные наборы; на Новый год — шоколад и ассорти-коробки.", en: "In Ramadan — Turkish delight, dates and tea sets; for New Year — chocolate and assorted gift boxes." },
          { az: "Bütün qutular əl işi ilə bəzədilir və hədiyyə üçün hazır təqdim olunur.", ru: "Все коробки оформляются вручную и готовы к дарению.", en: "All boxes are decorated by hand and presented ready to gift." },
        ],
      },
      {
        h2: { az: "Korporativ bayram hədiyyələri", ru: "Корпоративные праздничные подарки", en: "Corporate holiday gifts" },
        body: [
  ...
  },
  {
    ...
    sections: [
      {
        h2: { az: "Kimlər üçün uyğundur?", ru: "Кому подойдёт?", en: "Who are they for?" },
        body: [
      ...
      {
        h2: { az: "Fərdiləşdirmə", ru: "Персонализация", en: "Personalisation" },
        body: [
          { az: "Qutunun içindəkiləri, ölçüsünü və tərtibatını istəyinizə görə seçə bilərsiniz. Korporativ sifarişlər üçün loqo və xüsusi dizayn mümkündür.", ru: "Содержимое, размер и оформление коробки выбираете вы. Для корпоративных заказов возможны логотип и индивидуальный дизайн.", en: "You choose the contents, size and styling. Logo and custom design are available for corporate orders." },
        ],
      },
      {
        h2: { az: "Sifariş", ru: "Заказ", en: "Ordering" },
        body: [
          { az: "Kataloqa baxın, bəyəndiyinizi seçin və WhatsApp ilə sifariş edin — və ya Bakıdakı 11 mağazamızdan birinə gəlin.", ru: "Посмотрите каталог, выберите и закажите в WhatsApp — или зайдите в один из 11 магазинов в Баку.", en: "Browse the catalogue, choose and order on WhatsApp — or visit one of our 11 stores in Baku." },
        ],
      },
    ],
  },
  {
    ...
    sections: [
      {
        h2: { az: "Çeşidlər", ru: "Виды", en: "Varieties" },
        body: [
          { az: "Süd şokoladı, qara şokolad və qoz-fındıqlı qarışıqlar. Hər biri seçmə tərkib və zərif təqdimatla.", ru: "Молочный, тёмный шоколад и ассорти с орехами. Каждый — отборный состав и изящная подача.", en: "Milk chocolate, dark chocolate and nutty assortments. Each with selected ingredients and elegant presentation." },
        ],
      },
      {
        h2: { az: "Hədiyyə üçün şokolad", ru: "Шоколад в подарок", en: "Chocolate as a gift" },
        body: [
          { az: "Şokoladlar premium hədiyyə qutularının da əsas tərkib hissəsidir — bayram və korporativ hədiyyələr üçün ideal.", ru: "Шоколад — основа премиальных подарочных коробок: идеален для праздничных и корпоративных подарков.", en: "Chocolate is a core part of premium gift boxes — ideal for holiday and corporate gifts." },
        ],
      },
    ],
  },
  {
    ...
    sections: [
      {
        h2: { az: "Niyə Xurcun paxlavası?", ru: "Почему пахлава Xurcun?", en: "Why Xurcun baklava?" },
        body: [
          { az: "Təbii tərkib, konservant yoxdur, seçmə qoz-fındıq və balanslı şirinlik — hər tikədə ənənəvi dad.", ru: "Натуральный состав, без консервантов, отборные орехи и сбалансированная сладость — традиционный вкус в каждом кусочке.", en: "Natural ingredients, no preservatives, selected nuts and balanced sweetness — traditional taste in every piece." },
        ],
      },
      {
        h2: { az: "Bayram və hədiyyə üçün", ru: "Для праздника и подарка", en: "For holidays and gifting" },
        body: [
          { az: "Paxlava bayram süfrələrinin və hədiyyə xonçalarının ayrılmaz hissəsidir. Hədiyyə üçün hazır qutularda təqdim olunur.", ru: "Пахлава — неотъемлемая часть праздничного стола и подарочных хончей. Подаётся в готовых подарочных коробках.", en: "Baklava is essential to holiday tables and gift trays. It is presented in ready-to-gift boxes." },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        h2: { az: "Çeşidlər", ru: "Виды", en: "Varieties" },
        body: [
          { az: "Qoz lokum, püstəli lokum və meyvəli variantlar — müxtəlif dad və rəng seçimi.", ru: "Лукум с орехом, с фисташкой и фруктовые варианты — разнообразие вкусов и цветов.", en: "Walnut, pistachio and fruit varieties — a range of tastes and colours." },
        ],
      },
      {
        h2: { az: "Hədiyyə üçün lokum", ru: "Лукум в подарок", en: "Lokum as a gift" },
        body: [
          { az: "Lokum premium hədiyyə qutularının və toy xonçalarının sevimli tərkib hissəsidir.", ru: "Лукум — любимая часть премиальных подарочных коробок и свадебных хончей.", en: "Turkish delight is a favourite part of premium gift boxes and wedding trays." },
        ],
      },
    ],
  },
