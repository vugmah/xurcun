...
import {
  ...
  Lightbulb, MessageSquare, ShoppingBag, MapPin, QrCode, Coffee, Package, FileText, HelpCircle, Type, FileStack,
} from "lucide-react";
...
const navGroups: { group: string; items: NavItem[] }[] = [
  ...
  { group: "Marketinq", items: [
    ...
    { path: "/admin/page-text", icon: FileStack, label: "Səhifə mətnləri" },
